...
const createScene = function () {
    ...
    //load Modelf
    BABYLON.SceneLoader.Append("./assets/", "rare-cube.glb", scene, function (meshes) {
        ...
        scene.meshes.forEach(element => {
            ...
            if(element.name == 'Plane')
                element.isVisible = false
            if(element.name == 'front' || element.name == 'left' || element.name == 'back' || element.name == 'Right') {
